...
Set-Alias -Name ll -Value Get-ChildItem -option ReadOnly -ErrorAction SilentlyContinue
...
function Remove-MergedBranches
{
  git branch --merged |
    ...
    Where-Object { -not ( $_ -Like "*master" -or $_ -Like "*main"  -or $_ -like "*dev*" -or $_ -like "*release*" ) } |
